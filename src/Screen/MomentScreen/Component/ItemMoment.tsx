        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.footer}>
                <View style={styles.footerHeader}>
                    <TouchableOpacity>
                        <Image style={styles.imgLeftRight} source={require('../../../Resource/images/img_library.png')}></Image>
                    </TouchableOpacity>
                    <TouchableOpacity>
                        <Image style={styles.imgTakePhoto} source={require('../../../Resource/images/take.png')}></Image>
                    </TouchableOpacity>
                    <TouchableOpacity>
                        <Image style={styles.imgLeftRight} source={require('../../../Resource/images/img_video.png')}></Image>
                    </TouchableOpacity>
                </View> 
                ...
                <View style={styles.seeMore}>
                    ...
                    <TouchableOpacity>
                        <Image style={styles.imgSeeMore} source={require('../../../Resource/images/icon_down.png')}></Image>
                    </TouchableOpacity>
