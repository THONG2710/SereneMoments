    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.backgroundHeader}>
          ...
          <Image
            source={require('../../Resource/images/img_todo.png')}
      ...
      <View style={styles.center}>
        ...
        <View style={styles.finishTitle}>
          ...
          <Image
            source={require('../../Resource/images/icon_down.png')}
            style={styles.downFinish}></Image>
        </View>
        <View style={styles.itemTask}>
          {completedTasks.map(task => (
            <View style={styles.finished}>
              <Image
                ...
                style={styles.checked}></Image>
              <Text style={styles.textTaskFinished} key={task}>
                {task}
              </Text>
            </View>
          ))}
